          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6 lg:gap-4">
            {steps.map((step, i) => {
              ...
              return (
                ...
                >
                  <div className="relative z-10 w-12 h-12 md:w-14 md:h-14 rounded-full bg-bg-secondary border-2 border-border flex items-center justify-center mb-3 md:mb-4 group-hover:border-accent transition-colors">
                    <Icon className="w-6 h-6 text-accent" />
                    <div className="absolute -top-1.5 -right-1.5 w-5 h-5 md:w-6 md:h-6 rounded-full bg-accent text-white text-[10px] md:text-xs font-bold flex items-center justify-center">
                      {i + 1}
                    </div>
                  </div>
