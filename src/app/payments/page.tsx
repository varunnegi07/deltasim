...
const categories = [
  {
    ...
    icon: BookOpen,
    image: "/images/talent-simulation.svg",
    ...
    courses: [
      {
        ...
        image: "/images/solution-poster.svg",
      ...
      },
      {
        ...
        image: "/images/process-diagram.svg",
    ...
    <div ref={ref}>
      ...
      >
        <div className="flex items-start gap-6 md:gap-10">
          ...
          <div className="flex-shrink-0 hidden md:block mt-14">
            <img
              src={category.image}
              alt={category.title}
...
function CourseCard({ course, index }: { course: typeof categories[number]["courses"][number]; index: number }) {
  ...
  return (
    ...
    >
      <div className={`h-48 flex items-center justify-center ${isSold ? "bg-grey-100" : "bg-grey-50"}`}>
        <img
          src={course.image}
          alt={course.title}
